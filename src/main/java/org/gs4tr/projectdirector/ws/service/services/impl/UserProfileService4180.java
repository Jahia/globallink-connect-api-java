 ...
 * 
 */
@WebServiceClient(name = "UserProfileService_4180", 
...
public class UserProfileService4180 extends Service {
    ...
    public final static QName SERVICE = new QName("http://impl.services.service.ws.projectdirector.gs4tr.org", "UserProfileService_4180");
    ...
    public UserProfileService4180(URL wsdlLocation) {
        super(wsdlLocation, SERVICE);
    }

    public UserProfileService4180(URL wsdlLocation, QName serviceName) {
    ...
    public UserProfileService4180(WebServiceFeature ... features) {
    ...
    //API jar or re-run wsdl2java with "-frontend jaxws21" to generate JAX-WS 2.1
    //compliant code instead.
    public UserProfileService4180(URL wsdlLocation, WebServiceFeature ... features) {
    ...
    //API jar or re-run wsdl2java with "-frontend jaxws21" to generate JAX-WS 2.1
    //compliant code instead.
    public UserProfileService4180(URL wsdlLocation, QName serviceName, WebServiceFeature ... features) {
