 ...
 *         &lt;element name="inContextMatchWordCount" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class TmStatistics {
    ...
    /**
     * Gets the value of the inContextMatchWordCount property.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
    ...
    /**
     * Sets the value of the inContextMatchWordCount property.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setInContextMatchWordCount(Integer value) {
        this.inContextMatchWordCount = value;
    }
