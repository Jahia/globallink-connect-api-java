...
/**
 * <p>Java class for SubmissionSearchModelPagedList complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SubmissionSearchModelPagedList">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="elements" type="{http://dto.model.projectdirector.gs4tr.org/xsd}SimpleSubmissionSearchModel" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "SubmissionSearchModelPagedList", propOrder = {
    "elements",
    "pagedListInfo",
    "tasks",
    "totalCount"
})
public class SubmissionSearchModelPagedList {

    @XmlElement(nillable = true)
    protected List<SimpleSubmissionSearchModel> elements;
     ...
     * {@link SimpleSubmissionSearchModel }
     * 
     * 
     */
    public List<SimpleSubmissionSearchModel> getElements() {
        if (elements == null) {
            elements = new ArrayList<SimpleSubmissionSearchModel>();
        }
