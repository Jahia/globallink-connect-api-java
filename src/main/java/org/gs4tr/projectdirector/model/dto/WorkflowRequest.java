...
public class WorkflowRequest {
    ...
    public void setBatchWorkflowInfos(List<BatchWorkflowInfo> batchWorkflowInfos) {
    	this.batchWorkflowInfos = batchWorkflowInfos;
	}
    ...
    public void setLanguageWorkflowInfos(List<LanguageWorkflowInfo> languageWorkflowInfos) {
		this.languageWorkflowInfos = languageWorkflowInfos;
	}
	...
	public void setTargetWorkflowInfos(List<TargetWorkflowInfo> targetWorkflowInfos) {
		this.targetWorkflowInfos = targetWorkflowInfos;
	}
